 ...
 <Transition.Root show={open} as={Fragment}>
   ...
   >
      <div className='flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0'>
          ...
          >
              <div className="inline-block  bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm: align-middle-bottom sm:max-w-sm sm:w-full sm:p-6">
                    <div>
                  {selectedFile?(
                     <img src={selectedFile} onClick={()=>setSelectedFile(null)} alt=''/>
                  ):(
                    <div onClick={()=>filePickerRef.current.click()} className='mx-auto  flex items-center justify-center h-12 w-12 rounded-full bg-red-100'>
                    <CameraIcon className='h-6 text-red-600 ' aria-hidden='true'/>
                ...
                <div className='mt-3 text-center sm:mt-5'>
                    ...
                    <div>
                        <input
                         ...
                         type='file'
                          hidden
                          placeholder='pleace enter the caption' 
